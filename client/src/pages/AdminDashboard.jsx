            ...
            try {
                ...
                if (res.data.stats) {
                    setStats({
                        ...
                        pendingVerifications: res.data.stats.pendingVerifications, // Now Real!
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50 font-outfit">
                <div className="text-center p-12 glass-card max-w-md">
                    ...
                    <p className="text-slate-500 mb-8">This dashboard is strictly for the system administrator only.</p>
                    <button onClick={() => navigate('/')} className="btn-primary w-full py-4 rounded-2xl">Return to Safety</button>
                </div>
            </div>
        );
    }
